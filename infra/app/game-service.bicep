      ...
      containers: [
        {
          ...
          env: union([
            ...
            {
              name: 'AZURE_OPENAI_ENDPOINT1'
              value: azureOpenAiEndpoint1
            }
            {
              name: 'AZURE_OPENAI_API_KEY1'
              value: azureOpenAiApiKey1
            }
            {
              name: 'AZURE_OPENAI_DEPLOYMENT_NAME1'
              value: azureOpenDeploymentName1
            }
          ],
          env,
          map(secrets, secret => {
