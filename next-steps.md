...
#### Database connections for `chess-api`

- `AZURE_COSMOS_MONGODB_CONNECTION_STRING` environment variable is configured in [chess-api.bicep](./infra/app/chess-api.bicep) to connect to the MongoDB database. Modify this variable to match your application's needs.
...
- [app/chat-ui.bicep](./infra/app/chat-ui.bicep) - Azure Container Apps resources to host the 'chat-ui' service.
- [app/chess-api.bicep](./infra/app/chess-api.bicep) - Azure Container Apps resources to host the 'chess-api' service.
- [app/stockfish-server.bicep](./infra/app/stockfish-server.bicep) - Azure Container Apps resources to host the 'stockfish-server' service.
- [app/game-service.bicep](./infra/app/game-service.bicep) - Azure Container Apps resources to host the 'game-service' service.
- [app/db-cosmos.bicep](./infra/app/db-cosmos.bicep) - Azure Cosmos DB (MongoDB) to host the 'chess' database.
